...
namespace GameLogic.GameLogic.AI.AIComponents
{
    public class CowboyAI : BossAI
    {
        ...
        {
            List<UserInput> normalMoveSet = new List<UserInput>() { UserInput.Q, UserInput.W, UserInput.A, UserInput.D, UserInput.E };
            ...
            List<UserInput> threeQuartersHealthMoveSet = new List<UserInput> { UserInput.Q, UserInput.W, UserInput.E, UserInput.E, UserInput.A, UserInput.D, UserInput.E };
